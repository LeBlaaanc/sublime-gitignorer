# https://github.com/ExplodingCabbage/sublime-gitignorer/pull/20
...
def repo_ignored_paths(git_repo):
    ...
    relative_paths = [line.replace(u'Would remove ', u'', 1).replace(u'Would skip repository ', u'', 1).rstrip(u'/')
                      for line in lines]
